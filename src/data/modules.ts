...
export const modules: TrainingModule[] = [
  ...
  // ===================== OOschool DAY 1 =====================
  {
    ...
    brand: "ooschool",
    description:
      "歡迎加入 OOschool 無限學院！今天是你的第一天，我們會先帶你認識公司環境和集團介紹，然後進入最重要的部分——聽 8 段真實的開發 Call 錄音。這些錄音是你未來打電話的範本，請仔細聽語氣口吻、語調和受眾差異。OOschool 的客戶主要是想學 AI 人工智慧與 Python 程式設計的大學生、轉職上班族和創業家。下午會進行線上 Review 會議，之後開始兩人一組的逐字稿對練。今天的目標：熟悉開發架構，開始練習表達。",
    schedule: [
      { time: "10:00-11:00", task: "新人合約導讀", description: "了解合約內容與公司規範" },
      { time: "11:00-11:30", task: "公司環境、集團介紹", description: "認識墨宇集團三大品牌：nSchool 財經、XUEMI 學米、OOschool 無限" },
      { time: "12:00-13:00", task: "午休" },
      { time: "13:00-16:00", task: "【業訓】開發學習", description: "聽 8 段真實開發 Call 錄音逐字稿，邊聽邊筆記受眾特徵" },
      { time: "16:00-18:00", task: "【業訓】聽 Call Review", description: "線上會議，分享聽 Call 心得、教學制度說明（線上+實體課程、Python基礎→AI應用→數據分析→機械學習教學核心）" },
      { time: "18:00-19:00", task: "【業訓】逐字稿對練", description: "兩人一組，對練 1-1 到 1-4 逐字稿，裝話機互 Call" },
    ],
    content: [
      "【教學制度認識】OOschool 提供兩種教學形式：",
      "　• 線上課程 — 優勢：時間彈性、可重複觀看、不限地點、自己調整學習速度；劣勢：自律性要求高、缺乏即時互動",
      "　• 實體課程 — 優勢：即時互動、現場 Coding 指導、講師一對一 Debug；劣勢：時間固定、需要到場",
      "　➜ 教學核心：Python 基礎（影片由淺入深）→ AI 應用（教練帶你實作專案）→ 數據分析（真實資料集練手感）→ 機械學習（建立自己的模型）",
      "",
      "【開發 Call 學習】13:00 開始聽開發 Call 錄音（8段），邊聽邊記錄：",
      "　• 聽 Call 重點：語氣口吻、語調變化、受眾辨識（大學生/轉職者/創業家）",
      "　• 14:30 回報進度，聽到第幾段",
      "　• 15:00 受眾分析：大學生可以聊什麼？轉職者可以聊什麼？創業家可以聊什麼？列越多越好",
      "",
      "【受眾分析】你會遇到的客戶主要有三類：",
      "　• 大學生（18-22歲）— 可以聊：念什麼科系？有修過程式課嗎？同學都在學什麼？畢業後想做什麼？對 AI 有興趣嗎？",
      "　• 轉職上班族（25-35歲）— 可以聊：目前什麼產業？為什麼想轉職？有沒有聽過 Python？工程師薪水是不是很吸引人？目前有在自學嗎？",
      "　• 創業家（30-45歲）— 可以聊：創業做什麼產業？有沒有想過用 AI 提升效率？目前公司有在用數據分析嗎？想不想自己會寫程式？",
      "　➜ 客戶說的話信 50% 就好，重點是觀察他的真實需求",
      "",
      "【開發制度要點】",
      "　• 絕對不要問「想不想了解」→ 客戶一定說「不要不要」",
      "　• 正確做法：用「好不好」或直接引導時間 → 「今天？明天？上午？下午？10:00/11:00/14:00/16:00/18:00/20:00」",
      "　• 遇到有程式基礎的客戶：用請益方式 → 「0-10 分你覺得自己 Python 程度幾分？剩下幾分差在哪？」",
      "",
      "【聽 Call Review + 逐字稿對練】",
      "　• 16:00 線上 Review 會議：分享聽 Call 心得、教學制度說明",
      "　• 17:30 開始逐字稿對練：一人扮客戶、一人扮業務，照逐字稿念",
    ...
    keyPoints: [
      ...
      "練習核心三要素：①有無順暢（表達、溝通）②有條理邏輯（照架構順序走）③別人聽不聽得懂（語氣、語速、語調）",
      "一通 Call 大約落在 12-15 分鐘，多或少都要去找原因",
      "教學核心：Python 基礎（影片由淺入深）→ AI 應用（教練帶你做專案）→ 數據分析（真實資料集）→ 機械學習（建模實戰）",
      "邀約技巧：不問「想不想」，直接引導時間 →「今天？明天？上午？下午？幾點？」",
      "受眾以大學生、轉職上班族、創業家為主，很多人對程式零基礎。客戶話信 50% 就好，觀察真實需求",
    ],
    resources: [
      { title: "OOschool 無限訓練中心", type: "notion", url: "https://rattle-notify-a6d.notion.site/OOschool-training-center", description: "所有 OOschool 訓練資源的入口" },
      { title: "開發 Call 逐字稿（8段）", type: "notion", url: "https://rattle-notify-a6d.notion.site/ooschool-2025-c-03", description: "聽 Call 和對練用的逐字稿" },
      { title: "公司組織說明影片", type: "video", driveFileId: "1mFY5_pCtsuvDV0KiO2Ferh0SCJIflsZx", description: "墨宇集團組織架構與各部門介紹" },
    ],
    trainerTips: [
      "開發 Call 記得仔細去聽，語氣口吻和語調是關鍵",
      "有些夥伴可能不知道怎麼筆記，建議按受眾分類：大學生可以聊什麼？轉職者可以聊什麼？創業家可以聊什麼？",
      "電話行銷跟實體銷售不一樣，實體見面三分情，電話一分情都不到，透過聲音的起伏來調整",
      "如果學習快，有機會這周就學到 Demo，開始獨立作業和成交。但不逼，一步一步原則來走最重要",
      "OOschool 客群跟 nSchool 不一樣——這邊是想學程式、AI 的人，很多人有明確的轉職或創業動機",
    ],
    practiceTask: "逐字稿對練 1-1 到 1-4，兩人一組對練。對練完聽自己的錄音，標記卡住不熟的地方，心裡默念幾次",
    hasSparring: true,
    sparringType: "transcript_practice",
    tasks: [
      { id: "o1t1", title: "新人合約導讀", type: "info", time: "10:00-11:00", description: "了解公司合約內容與新人權益，有問題直接問" },
      { id: "o1t2", title: "公司環境、集團介紹", type: "info", time: "11:00-11:30", description: "認識墨宇集團三大品牌：nSchool 財經、XUEMI 學米、OOschool 無限" },
      { id: "o1t3", title: "聽開發 Call 錄音（8段）", type: "listen", time: "13:00-14:30", description: "邊聽邊筆記！重點聽：語氣口吻、語調變化、怎麼辨識受眾（大學生/轉職者/創業家）", resourceIndex: 1 },
      { id: "o1t4", title: "筆記：受眾分類分析", type: "note", description: "分三類整理 → 大學生可以聊什麼（科系/程式課/未來）？轉職者可以聊什麼（產業/薪水/自學經驗）？創業家可以聊什麼（AI效率/數據分析）？列越多越好", tip: "這些是你未來打電話最常用的話題" },
      { id: "o1t5", title: "回報目前進度", type: "review", time: "14:30", description: "向業訓回報聽到第幾段了" },
      { id: "o1t6", title: "了解教學制度", type: "info", description: "線上課程 vs 實體課程各有優劣。教學核心：Python基礎（影片）→ AI應用（教練帶做專案）→ 數據分析（真實資料集）→ 機械學習（建模實戰）", tip: "這是你跟客戶說明課程時最核心的邏輯" },
      { id: "o1t7", title: "了解開發制度", type: "info", description: "不要問「想不想了解」→ 客戶會說「不要」。正確做法：用「好不好」或直接引導時間 →「今天？明天？上午？下午？幾點？」", tip: "有程式基礎的客戶用請益法：0-10 你 Python 程度幾分？" },
      { id: "o1t8", title: "線上 Review 會議", type: "review", time: "16:00", description: "參加線上 Review 會議，分享聽 Call 心得、討論學習重點" },
      { id: "o1t9", title: "逐字稿對練 1-1 到 1-4", type: "practice", time: "17:30-18:30", description: "兩人一組，一人扮客戶、一人扮業務，照著逐字稿念。裝話機互 Call", resourceIndex: 1 },
      { id: "o1t10", title: "聽自己的對練錄音", type: "listen", description: "標記卡住不熟的地方，心裡默念幾次直到順暢" },
      { id: "o1t11", title: "完成每日測驗", type: "quiz", description: "通過測驗解鎖 Day 2", tip: "及格線 60 分" },
    ],
    quiz: [
      {
        question: "練習核心三要素不包括下列哪項？",
      ...
      {
        question: "OOschool 的教學核心路徑是什麼？",
        options: ["Python→考試→畢業", "Python基礎→AI應用→數據分析→機械學習", "看影片→背話術→打電話", "聽課→交報告→結業"],
        answer: 1,
      },
      {
        question: "一通開發 Call 正常應落在多少分鐘？",
      ...
      {
        question: "OOschool 的主要受眾不包括？",
        options: ["大學生（18-22歲）", "轉職上班族（25-35歲）", "退休族群（60歲以上）", "創業家（30-45歲）"],
        answer: 2,
      },
      {
        question: "邀約客戶時的正確做法是？",
        options: ["問客戶「想不想了解 AI 課程」", "直接引導時間：今天？明天？上午？下午？", "等客戶主動問", "發訊息就好不用打電話"],
        answer: 1,
      },
    ],
  },
  ...
  // ===================== OOschool DAY 2 =====================
  {
    ...
    brand: "ooschool",
    description:
      "今天的重點是從「念逐字稿」升級到「架構對練」。早上先完成逐字稿對練，接著學習打卡系統。下午進入架構對練——不再照著念，而是用自己的話走完整個開發架構（受眾分大學生/轉職者/創業家）。練完後會調你的 Call 出來一起 Review，找出 3 個優化點和 2 個可維持的地方。傍晚進行據點主管考試，通過後學習後台（CRM）操作。今天的目標：架構流程內化，通過考試。",
    schedule: [
      { time: "上午", task: "【業訓】逐字稿對練（續）", description: "完成 Day 1 未完成的逐字稿對練" },
      { time: "13:00-13:30", task: "【業訓】確認打卡信件", description: "打卡 APP 安裝、操作說明（12:30 準時打卡，12:31 算遲到）" },
      { time: "13:30-17:15", task: "【業訓】架構對練 + 聽 Call Review", description: "用自己的話走架構，受眾分大學生/轉職者/創業家。對練完聽錄音寫 3 優化 + 2 維持" },
      { time: "17:15-18:15", task: "【業訓】據點主管考試", description: "撥打據點主管分機進行考試，通過才能學後台" },
      { time: "18:15-19:00", task: "【業訓】後台學習、加入經辦", description: "後台操作影片（看到 48 分），登入 CRM 系統，加入經辦 LINE" },
    ],
    content: [
      "架構對練 TA 受眾：大學生 / 轉職上班族 / 創業家，客戶方自行設定輪廓",
      "對練記得受眾的個性和內容，不用特別跟對方說，當作真正上機一樣",
      "STEP2-STEP3 可以多聊天，講不出 AI 技術內容沒關係，聊客戶本身的狀況",
      "　• 大學生：你們學校有開 AI 相關的課嗎？同學有在學 Python 嗎？畢業想做什麼？",
      "　• 轉職者：目前工作做多久了？為什麼想學程式？有看過什麼線上課程嗎？",
      "　• 創業家：公司目前有用到什麼工具？有想過用 AI 自動化哪些流程？",
      "對練完後聽自己每通 Call，列出 3 個優化 + 2 個可維持的地方",
      "據點主管考試通過後，觀看後台操作影片（看到 48 分即可，後面會另外教學）",
      "用個人信箱註冊官網 ooschool.com.tw，後續會掛權限",
    ],
    keyPoints: [
      "架構對練三大核心：①順暢表達 ②有條理邏輯（照架構走）③別人聽得懂",
      "試著在 STEP2-STEP3 多聊天，了解客戶背景和需求——程式基礎、學習動機、時間安排",
      "不用特別刁鑽，主要是循序著架構去跑和執行",
      "後台操作影片看到 48 分就好，後面不要看，後續會教學",
    ],
    resources: [
      { title: "架構對練參考稿", type: "notion", url: "https://rattle-notify-a6d.notion.site/ooschool-dev-structure", description: "OOschool 開發架構完整對練參考" },
      { title: "後台操作教學影片（看到48分）", type: "video", driveFileId: "1879B7t_dR4_f94tkX8Nv1EYMULYFltmU", description: "CRM 後台操作教學（看到 48 分即可）" },
      { title: "後台操作完整教學", type: "video", driveFileId: "1kn-z8VXrTFhc0J5mPTlSj6IhtUBovT2r", description: "完整系統後台操作教學，新人必看" },
      { title: "開發 Call 逐字稿", type: "notion", url: "https://rattle-notify-a6d.notion.site/ooschool-2025-c-03", description: "逐字稿對練和架構對練用" },
    ],
    trainerTips: [
      "在開發階段，無須去說服，重點在引導",
      "引導是幫他戴帽子，讓他覺得「我行、我可以、學程式沒有想像中那麼難」",
      "大家聲音偏緊繃的話，放輕鬆。語氣語調都很重要，越緊張會越卡。太沉悶就站起來念",
      "STEP2 偶爾會卡住或趕快進入 STEP3，記得學會開話題→延伸→引導",
      "架構考試一次過就會讓你們上機了，基底訓練好很多新人業務都能做到",
      "OOschool 客戶很多是零基礎，要讓他們知道「完全不會也可以從頭開始學」",
    ],
    practiceTask: "架構對練（大學生/轉職者），兩人一組。練完聽 Call 寫 3 優化 + 2 維持。然後準備據點主管考試",
    hasSparring: true,
    sparringType: "structure_practice",
    tasks: [
      { id: "o2t1", title: "逐字稿對練（續）", type: "practice", time: "上午", description: "延續 Day 1 的逐字稿練習，加強不熟的段落" },
      { id: "o2t2", title: "確認打卡信件", type: "info", time: "13:00-13:30", description: "確認打卡信件已寄出" },
      { id: "o2t3", title: "架構對練（大學生/轉職者/創業家）", type: "practice", time: "13:30-17:15", description: "記得受眾的個性和內容，STEP2-STEP3 可以多聊天。大學生聊科系和 AI 興趣，轉職者聊產業和自學經驗，創業家聊 AI 效率需求" },
      { id: "o2t4", title: "聽 Call 寫 3 優化 + 2 維持", type: "note", description: "對練完後聽自己每通 Call，列出改善項目" },
      { id: "o2t5", title: "據點主管考試", type: "review", time: "17:15-18:15", description: "架構考試一次過就會讓你們上機！" },
      { id: "o2t6", title: "觀看後台操作影片（看到 48 分）", type: "watch", time: "18:15-19:00", description: "後台操作影片看到 48 分就好，後面不要看", resourceIndex: 1 },
      { id: "o2t7", title: "個人信箱註冊官網 ooschool.com.tw", type: "info", description: "用個人信箱註冊" },
      { id: "o2t8", title: "完成每日測驗", type: "quiz", description: "通過測驗解鎖 Day 3", tip: "及格線 60 分" },
    ],
    quiz: [
      {
        question: "架構對練和逐字稿對練的差別是？",
      ...
      {
        question: "OOschool 架構對練時，面對轉職者應該聊什麼？",
        options: ["直接介紹 AI 課程", "聊目前產業、為什麼想轉職、有沒有自學經驗", "只聊價格", "問他認不認識工程師"],
        answer: 1,
      },
    ],
  },
  ...
  // ===================== OOschool DAY 3 =====================
  {
    ...
    schedule: [
      { time: "10:00-12:00", task: "【業訓】上機前會議、強心針", description: "名單制度、CRM操作、KPI標準、成交率說明" },
      { time: "12:00-13:00", task: "午休" },
      { time: "13:00-19:00", task: "【業訓_無限】上機開發", description: "正式撥打！用 CRM 管理名單，邀約後操作 4 步驟" },
    ],
    content: [
      "【名單制度】",
      "　• 新單：一天 3 筆新單。開發量足夠＋邀約穩定（3-5 個/天）→ 加碼到 3-5 筆",
      ...
      "",
      "【CRM 聯絡紀錄模板】邀約成功後，複製這個模板填寫：",
      "　① 學習目標：客戶想學什麼？（例：學 Python/學 AI 應用/想轉職工程師/想用 AI 創業）",
      "　② 身分：大學生/上班族/創業家？幾歲？什麼科系或產業？",
      "　③ 學習動機＋經驗：為什麼想學？有沒有程式基礎？之前有自學過嗎？",
      "　④ 程式基礎：完全零基礎/有碰過一點/會其他語言（哪個）？",
      "　⑤ 學習時間：客戶每天/每週可以學多少時間？",
      "　⑥ 門檻：預算考量、家人意見、時間問題？",
      "　⑦ 裝置：筆電/桌電？什麼作業系統？（影響環境安裝建議）",
      "",
      "【邀約後 4 步驟】",
      "　STEP1. 下 CRM 聯絡紀錄（照上面模板填寫）",
      "　STEP2. 建立待辦清單，預約 Demo 時間",
    ...
    keyPoints: [
      ...
      "一開始邀約到不會做 Demo 沒關係，先 Pass 給學長姐協助（1-3 次），學完 Demo 就自己做",
      "新人成交率：5-6 個 Demo 出席 ＝ 1 成交。不要灰心，這是正常數字",
      "CRM 紀錄很重要！每通有效 Call 都要記錄：學習目標/身分/動機經驗/程式基礎/學習時間/門檻/裝置",
      "不要預設立場！CRM 上面寫拒絕的都稱之為狗屁判斷，沒有親自打過都不算",
    ],
    resources: [
      { title: "開發 Call 逐字稿", type: "notion", url: "https://rattle-notify-a6d.notion.site/ooschool-2025-c-03", description: "上機開發時架構參考" },
      { title: "銷售小工具（一鍵複製客戶資訊）", type: "notion", url: "https://ooschool-tools.github.io/notion-interactive/", description: "傳送給客戶的資訊工具" },
      { title: "業務 LINE 群（問題即時回報）", type: "notion", url: "https://line.me/R/ti/g/ooschool-sales", description: "遇到問題直接在群組提問，業訓會即時回覆" },
    ],
    trainerTips: [
      "遇到問題直接群組提出，你們遇過的問題我們都遇過了",
      "不管是操作、客戶對應不知道怎麼說，直接提問就好。用最快方式解決才會成長",
      "不要預設立場！CRM 上面寫拒絕的都稱之為狗屁判斷，沒有親自打過都不算",
      "業務不是天生就會，是可學習的技能。不要怕被拒絕，要怕沒有策略",
      "OOschool 的客戶很多是對 AI 有好奇心但不知道從何開始的人——你的角色就是幫他們找到起點",
    ],
    kpiTargets: {
      calls: "150",
      talkTime: "120 分鐘",
    ...
    sparringType: "live_call",
    tasks: [
      { id: "o3t1", title: "上機前會議、強心針", type: "review", time: "10:00-12:00", description: "了解名單制度、CRM 操作、KPI 標準、成交率。這些是每天都要用的工作習慣" },
      { id: "o3t2", title: "了解名單制度", type: "info", description: "新單一天 3 筆、結案單不預設立場、撥打順序：日期近→遠、次數少→多、6-7 次就不打", tip: "名單 1000 元/筆，不要亂打浪費" },
      { id: "o3t3", title: "學會 CRM 紀錄模板", type: "info", description: "每通有效 Call 都要記錄 7 項：學習目標/身分/動機經驗/程式基礎/學習時間/門檻/裝置", tip: "複製模板填寫最快，不用自己想格式" },
      { id: "o3t4", title: "了解 KPI 標準", type: "info", description: "0出席→130-160通/100-150分鐘/邀約4-5；1出席→100-140通/100-120分鐘/邀約3-4；2出席→80-120通/80-100分鐘/邀約2-3" },
      { id: "o3t5", title: "加入業務 LINE 群", type: "info", description: "掃 QR code 或點連結加入，遇到問題直接在群裡問", resourceIndex: 2 },
      { id: "o3t6", title: "正式上機開發", type: "call", time: "13:00-19:00", description: "第一天上機！用 CRM 管理名單，照撥打順序開始打。目標：150 通次 / 120 分鐘通時 / 3-5 邀約", tip: "不要預設立場！CRM 上面寫拒絕的都是狗屁判斷" },
      { id: "o3t7", title: "邀約成功 → 執行邀約後 4 步驟", type: "info", description: "①下 CRM 紀錄 ②建待辦預約 Demo ③LINE 改名（時間/姓名/英文名）④LINE 記事本存 CRM 資訊" },
      { id: "o3t8", title: "記錄今日 KPI 數據", type: "note", description: "記錄通次、通時、邀約數，回報到群組" },
      { id: "o3t9", title: "回報 Demo 客戶資訊", type: "info", description: "有邀約到 Demo 的客戶，把 CRM 資訊貼給業訓" },
      { id: "o3t10", title: "完成每日測驗", type: "quiz", description: "通過測驗解鎖 Day 4", tip: "及格線 60 分" },
    ],
    quiz: [
      {
        question: "一筆名單打幾次後就不用再打了？",
      ...
      {
        question: "OOschool CRM 紀錄模板中，「程式基礎」要記錄什麼？",
        options: ["客戶的手機型號", "完全零基礎/有碰過一點/會其他語言", "客戶的 GitHub 帳號", "客戶的學歷"],
        answer: 1,
      },
      {
        question: "撥打名單的正確順序是？",
  ...
  // ===================== OOschool DAY 4 =====================
  {
    ...
    brand: "ooschool",
    description:
      "今天開始學習 Demo（產品說明會）。OOschool 的 Demo 是透過 Google Meet 螢幕分享，1 對 1 帶客戶了解 AI/Python 課程內容。你會先觀看 Demo 訓練影片，學習 Demo 的架構和流程，然後分析過往成交案例來理解實戰怎麼做。Demo 要看三大重點：①架構——每個環節該說什麼話 ②信任感——如何搭建起來 ③反對問題——客戶提出的問題如何化解。看完後思考：如果你做 Demo，該怎麼做會更好？",
    schedule: [
      { time: "10:45-12:00", task: "【業訓】業訓日會/據點日會", description: "收斂昨日開發狀況、問題交流" },
      { time: "12:00-13:00", task: "午休" },
      { time: "13:00-17:00", task: "【業訓】學習 Demo", description: "觀看 OOschool Demo 影片、簡報、成交錄音分析三大重點" },
      { time: "17:00-19:00", task: "【業訓】學習 Demo（續）", description: "繼續消化 Demo 內容，做筆記" },
    ],
    content: [
      "【Demo 是什麼？】",
      "　• Demo ＝ 產品說明會，透過 Google Meet 螢幕分享，1 對 1 帶客戶了解 AI/Python 課程",
      "　• 不是在「賣課程」，是在幫客戶「規劃學習路徑」——從他的現況出發，找到適合的 AI/Python 學習方式",
      "",
      "【OOschool Demo 流程架構（P1-P12）】",
      "　• P1-P3 引言破冰：從「你是誰、為什麼對 AI/Python 有興趣」開始聊，不要直接進產品",
      "　• P4-P5 AI 趨勢與市場環境：讓客戶看到 AI 時代學程式的必要性——ChatGPT、自動化、AI 取代人力趨勢",
      "　• P6-P9 課程架構與學習價值：帶客戶看 Python 實作畫面、AI 專案成果、就業數據",
      "　• P9-P12 客製化方案說明與收尾：根據客戶身分推薦適合方案，短期(3個月)/中期(6個月)/長期(1年)",
      "",
      "【Demo 流程重點】",
      "　• AI 趨勢展示：讓客戶看到 AI 不是未來，是「現在」——ChatGPT、Copilot、AI 繪圖都已經在改變各行各業",
      "　• 課程架構展示：Python 基礎 → AI 應用 → 數據分析 → 機械學習 → 專案實作",
      "　• Python 實作展示：帶客戶看真實的 Coding 畫面和專案成果，讓他知道「學完可以做什麼」",
      "　• 就業數據展示：AI 工程師平均薪資、Python 相關職缺成長率、轉職成功案例",
      "　• 方案說明：根據客戶身分和需求推薦方案，6 個 tier（NT$108,000 - NT$200,000）",
      "",
      "【Demo 三大重點（一定要筆記）】",
      "　① 架構：每個環節該說什麼話、怎麼銜接——從 AI 趨勢引入到課程架構到方案",
      "　② 信任感：如何搭建起來、如何每次破冰——展示真實學員成果和就業數據",
      "　③ 反對問題處理：「我沒有程式基礎怎麼辦」「AI 會不會只是泡沫」「太貴了」等常見異議",
    ],
    keyPoints: [
      "OOschool Demo 流程：P1-P3 引言破冰 → P4-P5 AI 趨勢展示 → P6-P9 課程架構與實作展示 → P9-P12 客製化方案與收尾",
      "教學核心路徑：Python 基礎 → AI 應用 → 數據分析 → 機械學習 → 專案實作",
      "務必帶客戶看 Python 實作畫面和 AI 專案成果——讓他知道「學完可以做什麼」",
      "收尾三次確認：AI 趨勢認同、為什麼現在開始學、什麼時候開始→帶入個人學習計畫",
      "方案價格 6 個 tier：NT$108,000 / NT$128,000 / NT$148,000 / NT$168,000 / NT$188,000 / NT$200,000",
    ],
    resources: [
      { title: "OOschool Demo 簡報", type: "video", driveFileId: "1vXYqVJwVCZnTl44G3SXJQ7s_TUKnxAqe", description: "OOschool Demo 完整簡報檔" },
      { title: "OOschool Demo 流程示範", type: "video", driveFileId: "1YxSdBZ0dCeivMh3N8LPMeSZiADODBY9R", description: "標準 OOschool Demo 流程完整示範" },
      { title: "楊祤豪 Demo 實戰（無限）", type: "video", driveFileId: "1E3P2xgf2f-Yb7K4c-EgwwZo5T87_l3v0", description: "OOschool 實戰 Demo 錄影" },
      { title: "陳紀志 Demo 實戰（無限）", type: "video", driveFileId: "1ajWVjfEcCBQdVkiPqXOFTgJd8xKfPo_4", description: "OOschool 實戰 Demo 錄影" },
      { title: "洪楷雯 Demo 實戰（無限）", type: "video", driveFileId: "1LxS5S27f_yIvXQz1JE9kVDqWjNiuJpVe", description: "OOschool 實戰 Demo 錄影" },
    ],
    trainerTips: [
      "先把 Demo 資訊記得去把每個銷售點和問題給記錄",
      "筆記很重要，你自己能吸收不能吸收會是重點",
      "Demo 要去看：①架構每個環節該說什麼 ②信任感如何搭建 ③反對問題如何化解",
      "看完後思考：如果我做 Demo，該怎麼做會更好",
      "不是在賣課程，是在幫客戶規劃 AI/Python 學習路徑——從他的現況出發，找到適合的方式",
      "很多客戶會問「AI 會不會只是泡沫」——要準備好數據和趨勢來回應",
    ],
    practiceTask: "觀看 OOschool Demo 簡報和 3 支實戰 Demo 影片，針對三大重點（架構、信任感、反對問題）做筆記。每支影片各寫出 1 個學到的技巧",
    hasSparring: false,
    tasks: [
      { id: "o4t1", title: "業訓日會 / 據點日會", type: "review", time: "10:45-12:00", description: "參加日會，了解今日訓練重點" },
      { id: "o4t2", title: "觀看 OOschool Demo 簡報", type: "watch", time: "13:00-14:00", description: "了解 Demo 的完整簡報架構（P1-P12）", resourceIndex: 0 },
      { id: "o4t3", title: "觀看 OOschool Demo 流程示範", type: "watch", time: "14:00-15:30", description: "標準 Demo 流程完整示範影片", resourceIndex: 1 },
      { id: "o4t4", title: "觀看楊祤豪 Demo 實戰", type: "watch", description: "OOschool 實戰 Demo，學習實際操作", resourceIndex: 2 },
      { id: "o4t5", title: "觀看陳紀志 Demo 實戰", type: "watch", description: "OOschool 實戰 Demo，學習信任感搭建", resourceIndex: 3 },
      { id: "o4t6", title: "觀看洪楷雯 Demo 實戰", type: "watch", description: "OOschool 實戰 Demo，學習反對問題處理", resourceIndex: 4 },
      { id: "o4t7", title: "Demo 三大重點筆記", type: "note", description: "針對架構、信任感、反對問題做筆記", tip: "每支影片各寫出 1 個學到的技巧" },
      { id: "o4t8", title: "完成每日測驗", type: "quiz", description: "通過測驗解鎖 Day 5", tip: "及格線 60 分" },
    ],
    quiz: [
      {
        question: "OOschool Demo 的三大重點不包括哪項？",
        options: ["架構每個環節該說什麼", "信任感如何搭建", "反對問題如何化解", "快速報價成交"],
        answer: 3,
      },
      {
        question: "OOschool Demo 中 P4-P5 的重點是？",
        options: ["直接介紹課程價格", "展示 AI 趨勢與市場環境，讓客戶看到學程式的必要性", "播放公司廣告", "問客戶預算"],
        answer: 1,
      },
      {
        question: "OOschool 教學核心路徑的正確順序是？",
        options: ["機械學習→AI→Python→數據", "Python基礎→AI應用→數據分析→機械學習→專案實作", "隨便學都可以", "只學 Python 就好"],
        answer: 1,
      },
      {
        question: "Demo 收尾時的三次確認是？",
        options: ["價格→付款→簽約", "AI趨勢認同→為什麼現在開始學→什麼時候開始", "介紹課程→報價→成交", "提問→回答→結束"],
        answer: 1,
      },
      {
        question: "OOschool 方案有幾個 tier？",
  ...
  // ===================== OOschool DAY 5 =====================
  {
    ...
    schedule: [
      ...
      { time: "11:00-12:00", task: "【業訓】上機開發" },
      { time: "12:00-13:00", task: "午休" },
      { time: "13:00-16:00", task: "【業訓_無限】上機", description: "持續撥打，整合開發架構 + Demo 知識" },
    ],
    content: [
      "【業訓日會內容】",
      "　• 收斂昨日 Demo 影片學到的問題",
      "　• 成交後流程教學 → 簽約後的完整操作流程",
      "　• 銷售方案說明 → OOschool 6 個 tier 方案內容、價格邏輯、選課建議",
      "　• 課程結構說明 → 五大領域：Python程式設計/AI應用/數據分析/機械學習/專案實作",
      "　• 金流申辦 → 簽約後金流處理方式（刷卡/匯款/分期）",
      "",
      "【OOschool 課程五大領域（Demo 時要能跟客戶說明）】",
      "　① Python 程式設計：從零開始學 Python、變數/迴圈/函式/物件導向、實作小專案",
      "　② AI 應用：ChatGPT API 串接、AI 工具應用、Prompt Engineering、AI 自動化流程",
      "　③ 數據分析：Pandas/NumPy 資料處理、資料視覺化（Matplotlib/Seaborn）、商業數據分析實戰",
      "　④ 機械學習：監督式/非監督式學習、模型訓練與評估、Scikit-learn/TensorFlow 入門",
      "　⑤ 專案實作：整合所有學習成果，完成一個完整的 AI 專案，可放進作品集",
      "",
      "【OOschool 方案價格（6 個 tier）】",
      "　• Tier 1：NT$108,000 — Python 基礎 + AI 應用入門（3 個月）",
      "　• Tier 2：NT$128,000 — Python + AI 應用 + 數據分析（6 個月）",
      "　• Tier 3：NT$148,000 — Python + AI + 數據 + 機械學習（9 個月）",
      "　• Tier 4：NT$168,000 — 全領域學習 + 專案實作（12 個月）",
      "　• Tier 5：NT$188,000 — 全領域 + 進階專案 + 就業輔導（12 個月）",
      "　• Tier 6：NT$200,000 — VIP 全方位方案 + 1對1 教練 + 保證就業輔導（12 個月）",
      "",
      "【持續上機開發】",
      "　• 整合這幾天學到的開發架構，穩定通時通次",
      "　• 有邀約就開始嘗試自己做 Demo（學長姐旁聽輔助）",
    ...
    keyPoints: [
      "第一週 → 訓練開發、練熟架構 → 第三天或第四天開始有邀約 → Pass 給學長 → 出單 → 學習 Demo",
      "OOschool 課程五大領域：Python程式設計、AI應用、數據分析、機械學習、專案實作",
      "方案 6 個 tier：NT$108,000 到 NT$200,000，根據學習時長和內容深度遞增",
      "新人成交率：5-6 個 Demo 出席 = 1 成交；正式業務 4-5 個；資深業務 3-4 個",
      "業績好的不一定很聰明，但一定自律、努力、正面、積極、抗壓性強",
    ],
    resources: [
      { title: "成交後流程", type: "notion", url: "https://rattle-notify-a6d.notion.site/ooschool-close-flow", description: "簽約後的完整操作流程" },
      { title: "銷售方案", type: "notion", url: "https://rattle-notify-a6d.notion.site/ooschool-sales-plan", description: "OOschool 6 tier 方案內容與價格" },
      { title: "課程結構", type: "notion", url: "https://rattle-notify-a6d.notion.site/ooschool-course-structure", description: "五大領域課程大綱" },
      { title: "金流申辦", type: "notion", url: "https://rattle-notify-a6d.notion.site/ooschool-payment", description: "簽約後金流處理方式" },
      { title: "OOschool Demo 簡報", type: "video", driveFileId: "1vXYqVJwVCZnTl44G3SXJQ7s_TUKnxAqe", description: "Demo 時使用的完整簡報" },
    ],
    trainerTips: [
      "學完 Demo 之後就可以自己做了，1-3 次 Pass 之後就要自己來",
      "持續穩定通時通次，這是一切成交的基礎",
      "Demo 時記得前後呼應：開頭問他為什麼想學 AI/Python、中間帶課程架構、收尾拉回他的初衷",
      "OOschool 的客戶很在意「學完能做什麼」——要讓他看到具體的就業數據和專案成果",
      "強者則強，弱者恆弱。未來你們學完一定可以的，加油！",
    ],
    kpiTargets: {
      calls: "130-160",
    ...
    sparringType: "live_call",
    tasks: [
      { id: "o5t1", title: "業訓日會", type: "review", time: "09:45-11:00", description: "收斂 Demo 問題、學習成交後流程/銷售方案/課程結構/金流" },
      { id: "o5t2", title: "看懂成交後流程", type: "info", description: "簽約後的完整操作流程（開帳號、寄 Welcome Mail、加入學習群）", resourceIndex: 0 },
      { id: "o5t3", title: "了解銷售方案和課程結構", type: "info", description: "五大領域：Python程式設計/AI應用/數據分析/機械學習/專案實作。了解 6 tier 方案和價格邏輯", resourceIndex: 1 },
      { id: "o5t4", title: "了解金流申辦", type: "info", description: "刷卡/匯款/分期的處理方式", resourceIndex: 3 },
      { id: "o5t5", title: "上機開發", type: "call", time: "11:00-19:00", description: "目標：130-160 通次 / 100-150 分鐘通時 / 4-5 邀約", tip: "整合這幾天學到的所有架構知識" },
      { id: "o5t6", title: "嘗試自己做 Demo", type: "practice", description: "有 Demo 出席就嘗試自己做，旁邊有學長姐輔助", tip: "1-3 次 Pass 之後就要自己來！記得 Demo 前看客戶的 CRM 資訊" },
      { id: "o5t7", title: "回報今日數據", type: "note", description: "下班前回報通次/通時/邀約/Demo 狀況到群組" },
      { id: "o5t8", title: "完成每日測驗", type: "quiz", description: "通過測驗解鎖 Day 6", tip: "及格線 60 分" },
    ],
    quiz: [
      {
        question: "OOschool 課程的五大領域不包括？",
        options: ["Python 程式設計", "AI 應用", "機械學習", "區塊鏈開發"],
        answer: 3,
      },
      {
        question: "OOschool 最便宜的方案是多少？",
        options: ["NT$68,000", "NT$88,000", "NT$108,000", "NT$128,000"],
        answer: 2,
      },
      {
        question: "第一週的重點進程是？",
  ...
  // ===================== OOschool DAY 6 =====================
  {
    ...
    brand: "ooschool",
    description:
      "你已經完成第一週的訓練了！從今天開始進入進階階段——不再只是走完架構，而是要把架構內化到可以自然對話。重點練習 STEP2-STEP3 的深度聊天能力，以及根據不同受眾（大學生/轉職者/創業家）調整引導方式。OOschool 的客群有明確的學習動機，你要學會挖掘他們背後真正的需求。",
    content: [
      "【深度架構對練】不再照架構念，要做到自然對話",
      "",
      "【受眾分析進階】不同受眾的切入點、痛點、關注點完全不同：",
      "　• 大學生（18-22歲）→ 聊科系、有沒有修過程式課、同學都在學什麼、畢業後想做什麼工作、對 AI 領域的想法",
      "　• 轉職上班族（25-35歲）→ 聊目前工作做多久了、為什麼想轉職、有沒有自學過程式、工程師薪水是不是很吸引、目前有用什麼學習資源",
      "　• 創業家（30-45歲）→ 聊公司規模和產業、有沒有在用 AI 工具、想用程式解決什麼問題、公司有數據分析需求嗎、想不想自己能看懂技術",
      "",
      "【三步引導法（OOschool 版）】",
      "　• 確認興趣：「你之前有聽過 Python 嗎？對 AI 哪個方面比較有興趣？」",
      "　• 展示成果：「我們很多學員從零基礎開始，3 個月就做出自己的 AI 專案了」",
      "　• 安排體驗：「我們有一個 30 分鐘的免費體驗課，我幫你安排一下好不好？」",
      "",
      "【引導技巧深化】",
      "　• 引導 ＝ 幫客戶戴帽子，讓他覺得「學程式沒有想像中那麼難、我可以做到」",
      "　• 引導 ≠ 說服。不要去說服客戶，要讓他自己說出學習需求",
      "　• 遇到有程式基礎的客戶：用請益方式 → 「0-10 你覺得自己 Python 程度幾分？剩下幾分差在哪？」",
      "",
      "【複習】聽自己上週的 Call 錄音，找出與優秀錄音的差距",
    ],
    keyPoints: [
      "架構是骨幹，語氣和引導才是靈魂",
      "STEP2 不要急著進入 STEP3，多花時間了解客戶背景——程式基礎、學習動機、轉職目標",
      "引導 ≠ 說服，幫客戶找到他沒看到的可能性——「學會 Python 之後你可以...」",
      "三步引導法：確認興趣→展示成果→安排體驗",
      "開發制度：避免說「想不想」→「不要不要」，改用「好不好」或直接引導時間",
    ],
    trainerTips: [
      "受眾分析：大學生聊科系和 AI 興趣；轉職者聊產業和自學經驗；創業家聊 AI 效率需求",
      "邀約不是問對方有沒有空，是直接引導：今天？明天？上午？下午？幾點？",
      "OOschool 的客戶很多是對 AI 有好奇心的人，用「展示成果」最有效——讓他看到別人做到了",
      "有程式基礎的客戶用請益方式：「0-10 你 Python 程度幾分？剩下幾分差在哪？」",
      "零基礎的客戶最怕「我學不會」——要讓他知道我們的課程就是為零基礎設計的",
    ],
    practiceTask: "進階架構對練，按受眾分（大學生/轉職者/創業家），全程自然對話不看稿。對練完聽錄音，對比優秀錄音找差距",
    hasSparring: true,
    sparringType: "full_call",
    tasks: [
      { id: "o6t1", title: "聽自己上週的 Call 錄音", type: "listen", description: "找出與優秀錄音的差距" },
      { id: "o6t2", title: "受眾分析進階", type: "note", description: "大學生聊科系/AI興趣；轉職者聊產業/自學經驗；創業家聊AI效率/數據需求" },
      { id: "o6t3", title: "學習三步引導法", type: "info", description: "確認興趣→展示成果→安排體驗。OOschool 版的引導方式", tip: "展示成果最有效——讓客戶看到別人從零基礎做到了" },
      { id: "o6t4", title: "進階架構對練（不看稿）", type: "practice", description: "按受眾分（大學生/轉職者/創業家），全程自然對話", tip: "STEP2 不要急著進入 STEP3，多花時間了解客戶的程式基礎和學習動機" },
      { id: "o6t5", title: "對練完聽錄音找差距", type: "listen", description: "對比優秀錄音，找出可以優化的地方" },
      { id: "o6t6", title: "完成每日測驗", type: "quiz", description: "通過測驗解鎖 Day 7", tip: "及格線 60 分" },
    ],
    quiz: [
      {
        question: "OOschool 三步引導法的正確順序是？",
        options: ["報價→成交→跟進", "確認興趣→展示成果→安排體驗", "介紹公司→介紹課程→報價", "問問題→回答→結束"],
        answer: 1,
      },
      {
        question: "面對有程式基礎的客戶，應該用什麼方式？",
        options: ["直接教他進階課程", "請益方式：0-10 你 Python 程度幾分？剩下差在哪？", "跳過背景探索", "說我們的課太簡單你不需要"],
        answer: 1,
      },
      {
        question: "面對零基礎的客戶，最重要的是？",
        options: ["告訴他程式很難要有心理準備", "讓他知道課程就是為零基礎設計的，很多人從零開始學會了", "建議他先自學再來", "跳過這個客戶"],
        answer: 1,
      },
    ],
  },
  ...
  // ===================== OOschool DAY 7 =====================
  {
    ...
    brand: "ooschool",
    description:
      "今天專注練習 OOschool Demo 實戰。兩人一組模擬完整 Demo 流程——從引言破冰到 AI 趨勢展示到課程架構說明到客製化方案收尾。重點練習反對問題處理：「我沒有程式基礎」「AI 會不會只是泡沫」「太貴了」「我要想想」「我沒時間學」等常見異議。記得 Demo 不是在賣課程，是在幫客戶規劃 AI/Python 學習路徑。",
    content: [
      "【Demo 完整對練】一人扮業務做完整 OOschool Demo，一人扮客戶提異議",
      "",
      "【OOschool 常見反對問題與處理方式】",
      "　• 「我沒有程式基礎」→ 我們的課程就是為零基礎設計的，從最基本的 Hello World 開始教。80% 的學員入學時都是零基礎",
      "　• 「AI 會不會只是泡沫」→ 帶數據：AI 相關職缺年增 40%、各大企業都在招聘 AI 人才、ChatGPT 使用者已破億。這不是泡沫，是新的基礎能力",
      "　• 「太貴了」→ 了解背後真正顧慮。算 ROI：轉職成功後薪水提升 30-50%，投資學習 3-6 個月就回本",
      "　• 「我要想想」→ 不要逼他，但問清楚想什麼：是預算問題？時間問題？還是不確定適不適合？針對真正原因回應",
      "　• 「我沒時間學」→ 線上課程可以自己安排，每天 1-2 小時就夠。很多學員都是邊上班邊學的",
      "",
      "【角色扮演客戶設定】練習時設定不同受眾背景：",
      "　• 大學生：資工系大三、對 AI 有興趣但不知道從哪開始、預算有限（爸媽出錢）",
      "　• 轉職者：行銷主管做 5 年了、看到 AI 趨勢想轉職、有自學過一點 Python 但卡住了",
      "　• 創業家：電商老闆、想用 AI 做客戶數據分析、自己看不懂技術文件",
      "",
      "【客製化規劃練習】根據客戶身分推薦方案：",
      "　• 大學生：Tier 1-2（基礎+應用，畢業前學完）",
      "　• 轉職者：Tier 3-4（全領域，轉職需要完整技能樹）",
      "　• 創業家：Tier 4-5（全領域+專案實作，可以直接用在公司）",
    ],
    keyPoints: [
      "反對問題的表面≠真正顧慮，要挖掘背後原因",
      "客製化規劃要具象化：讓客戶看到「3 個月後我可以做什麼、6 個月後可以做什麼」",
      "收尾三次確認：AI趨勢認同→為什麼現在開始學→什麼時候開始",
      "不會從「你錯了」的角度說話，而是從「我們一起規劃怎麼走得更輕鬆」引導",
      "零基礎不是障礙，是我們的強項——OOschool 就是為零基礎設計的",
    ],
    resources: [
      { title: "OOschool Demo 簡報", type: "video", driveFileId: "1vXYqVJwVCZnTl44G3SXJQ7s_TUKnxAqe", description: "Demo 時使用的完整簡報" },
      { title: "OOschool Demo 流程示範", type: "video", driveFileId: "1YxSdBZ0dCeivMh3N8LPMeSZiADODBY9R", description: "標準 OOschool Demo 完整示範" },
      { title: "楊祤豪 Demo 實戰（無限）", type: "video", driveFileId: "1E3P2xgf2f-Yb7K4c-EgwwZo5T87_l3v0", description: "OOschool 實戰 Demo 錄影" },
      { title: "陳紀志 Demo 實戰（無限）", type: "video", driveFileId: "1ajWVjfEcCBQdVkiPqXOFTgJd8xKfPo_4", description: "OOschool 實戰 Demo 錄影" },
      { title: "洪楷雯 Demo 實戰（無限）", type: "video", driveFileId: "1LxS5S27f_yIvXQz1JE9kVDqWjNiuJpVe", description: "OOschool 實戰 Demo 錄影" },
    ],
    trainerTips: [
      "Demo 的引言就是重新開發：先從「他是誰、為什麼對 AI 有興趣」開始聊，不要直接進產品",
      "從職涯拉到 AI 時代的焦慮——「現在不學 AI，5 年後會不會被取代？」這裡是關鍵",
      "記下客戶說的話，後面介紹課程時回扣他親口說的——讓他自己看見現況和未來的差距",
      "零基礎的客戶最怕學不會——多舉例：「我們有個學員之前是護理師，現在轉職成功在做數據分析」",
      "Demo 時一定要帶客戶看 Python 實作畫面——讓他看到「原來寫程式是這樣」，破除恐懼感",
    ],
    practiceTask: "兩人一組模擬完整 OOschool Demo，一人設定客戶異議（沒基礎/太貴/沒時間/AI泡沫）。對練完互評三大重點，再對換角色",
    hasSparring: true,
    sparringType: "demo",
    tasks: [
      { id: "o7t1", title: "複習 OOschool Demo 流程", type: "watch", description: "再看一次 Demo 簡報和流程示範", resourceIndex: 0 },
      { id: "o7t2", title: "觀看 Demo 實戰影片（3支）", type: "watch", description: "楊祤豪、陳紀志、洪楷雯的實戰 Demo 錄影", resourceIndex: 2 },
      { id: "o7t3", title: "Demo 完整對練", type: "practice", description: "一人扮業務做完整 OOschool Demo，一人扮客戶提異議" },
      { id: "o7t4", title: "反對問題處理練習", type: "practice", description: "練習處理「沒基礎/AI泡沫/太貴/沒時間/要想想」", tip: "反對問題的表面≠真正顧慮，要挖背後原因" },
      { id: "o7t5", title: "客製化方案推薦練習", type: "note", description: "根據不同受眾推薦 tier：大學生 Tier 1-2、轉職者 Tier 3-4、創業家 Tier 4-5" },
      { id: "o7t6", title: "互評三大重點", type: "review", description: "架構、信任感、反對問題 — 互相給回饋" },
      { id: "o7t7", title: "完成每日測驗", type: "quiz", description: "通過測驗解鎖 Day 8", tip: "及格線 60 分" },
    ],
    quiz: [
      {
        question: "OOschool Demo 引言的正確做法是？",
        options: ["直接介紹 AI 課程", "先從「他是誰、為什麼對 AI 有興趣」開始聊", "播放公司介紹影片", "讀簡報"],
        answer: 1,
      },
      {
        question: "客戶說「我沒有程式基礎」時，應該？",
        options: ["建議他先自學", "告訴他課程就是為零基礎設計的，80% 學員入學時都是零基礎", "跳過這個客戶", "說程式很簡單不用擔心"],
        answer: 1,
      },
      {
        question: "客戶說「AI 會不會只是泡沫」時，應該？",
        options: ["說「不會」就好", "帶數據：AI職缺年增40%、各大企業招聘AI人才、ChatGPT破億用戶", "承認是泡沫", "轉移話題"],
        answer: 1,
      },
      {
        question: "大學生客戶應該推薦哪個 tier？",
        options: ["Tier 5-6", "Tier 1-2", "Tier 3-4", "最貴的就對了"],
        answer: 1,
      },
    ],
  },
  ...
  // ===================== OOschool DAY 8 =====================
  {
    ...
    brand: "ooschool",
    description:
      "把這段時間學到的所有技能整合——從第一通開發電話到邀約到 Demo 到成交的完整閉環。今天的重點是模擬真實客戶的全流程：開發 Call → 邀約 → OOschool Demo → 處理異議 → 收尾。用 AI 對練或跟夥伴練習，把每個環節串起來。記住：開發時聊 AI/Python 興趣，Demo 時展示課程平台和專案成果，收尾時拉回客戶的初衷。",
    content: [
      "【全流程模擬】開發 Call → 邀約 → OOschool Demo → 反對問題 → 收尾",
      "",
      "【開發 Call 重點回顧】",
      "　• 架構 7 步驟完整走一遍，控制在 12-15 分鐘",
      "　• 三步引導法：確認興趣→展示成果→安排體驗",
      "　• 受眾切入：大學生聊科系/AI興趣、轉職者聊產業/自學經驗、創業家聊AI效率",
      "",
      "【Demo 重點回顧】",
      "　• P1-P3 引言破冰：從 AI 興趣出發",
      "　• P4-P5 AI 趨勢：ChatGPT、自動化、AI取代趨勢",
      "　• P6-P9 課程架構：Python→AI→數據→機械學習→專案",
      "　• P9-P12 方案推薦：根據身分推薦 tier + 客製化學習計畫",
      "",
      "【時間管理】",
      "　• 開發 Call 控制在 12-15 分鐘",
      "　• Demo 控制在 60 分鐘內",
      "　• 全流程從開發到收尾，模擬 75-80 分鐘",
      "",
      "【成交收尾技巧】",
      "　• 三次確認：AI趨勢認同→為什麼現在學→什麼時候開始",
      "　• 方案說明後給選擇：「你覺得 Tier 3 還是 Tier 4 比較適合你？」不要問「要不要」",
      "　• 拉回初衷：「你剛才說想轉職做工程師，這個方案就是為你規劃的」",
    ],
    resources: [
      { title: "開發 Call 逐字稿", type: "notion", url: "https://rattle-notify-a6d.notion.site/ooschool-2025-c-03", description: "開發架構參考" },
      { title: "OOschool Demo 簡報", type: "video", driveFileId: "1vXYqVJwVCZnTl44G3SXJQ7s_TUKnxAqe", description: "Demo 簡報" },
      { title: "OOschool Demo 流程示範", type: "video", driveFileId: "1YxSdBZ0dCeivMh3N8LPMeSZiADODBY9R", description: "Demo 流程示範" },
      { title: "楊祤豪 Demo 實戰", type: "video", driveFileId: "1E3P2xgf2f-Yb7K4c-EgwwZo5T87_l3v0", description: "OOschool 實戰 Demo" },
      { title: "陳紀志 Demo 實戰", type: "video", driveFileId: "1ajWVjfEcCBQdVkiPqXOFTgJd8xKfPo_4", description: "OOschool 實戰 Demo" },
    ],
    keyPoints: [
      "全流程：開發→邀約→Demo→結單，每個環節都要有意識地練習",
      "開發 Call 12-15 分鐘是健康範圍",
      "Demo 60 分鐘內完成",
      "通時通次才會有邀約數，訓練業務力才會有成交",
      "收尾給選擇不問「要不要」——「Tier 3 還是 Tier 4 比較適合你？」",
    ],
    trainerTips: [
      "把模擬當作真實客戶，不要因為是練習就鬆懈",
      "每完成一次全流程，寫出 3 個做得好的 + 3 個要優化的",
      "業務就是敢去做敢去衝，不是預設立場最後瘋狂修補",
      "OOschool 的優勢是「AI 是趨勢」——這個時代大勢讓你的銷售更有說服力",
    ],
    practiceTask: "完成至少一次完整的全流程模擬（開發→邀約→OOschool Demo→收尾），記錄自己每個環節的表現",
    hasSparring: true,
    sparringType: "full_call",
    tasks: [
      { id: "o8t1", title: "開發架構 7 步驟完整走一遍", type: "practice", description: "開發 Call 控制在 12-15 分鐘，用三步引導法" },
      { id: "o8t2", title: "OOschool Demo 架構完整走一遍", type: "practice", description: "從引言到 AI 趨勢到課程架構到方案推薦，控制在 60 分鐘" },
      { id: "o8t3", title: "全流程模擬", type: "practice", description: "開發→邀約→Demo→反對問題→收尾。收尾給選擇不問要不要", tip: "把模擬當作真實客戶，不要鬆懈" },
      { id: "o8t4", title: "寫出 3 優 + 3 優化", type: "note", description: "每完成一次全流程，記錄做得好和要改進的" },
      { id: "o8t5", title: "複習 Demo 實戰影片", type: "watch", description: "再看一次楊祤豪、陳紀志的 Demo 實戰", resourceIndex: 3 },
      { id: "o8t6", title: "完成每日測驗", type: "quiz", description: "通過測驗解鎖 Day 9", tip: "及格線 60 分" },
    ],
    quiz: [
      {
        question: "完整銷售流程的順序是？",
      ...
      {
        question: "OOschool Demo 收尾時應該怎麼給選擇？",
        options: ["問「要不要報名」", "問「Tier 3 還是 Tier 4 比較適合你？」", "直接幫他選最貴的", "不用收尾讓客戶自己決定"],
        answer: 1,
      },
      {
        question: "「通時通次才會有邀約數」的意思是？",
  ...
  // ===================== OOschool DAY 9 =====================
  {
    ...
    brand: "ooschool",
    description:
      "最終考核！你會面對一位模擬客戶，完整走完一通開發 Call 的 7 步驟架構。這不是背誦考試——而是看你能不能像真實打電話一樣自然地引導對 AI/Python 有興趣的客戶。評分看的是：開場力、背景探索深度、引導技巧、架構完整性、異議處理、成交推進。70 分及格。",
    content: [
      "考核形式：模擬真實客戶（想學 AI/Python 的大學生、轉職者或創業家），完整走完一通開發 Call",
      "評分維度：開場力、背景探索深度、引導技巧、架構完整性、異議處理、成交推進",
      "及格標準：綜合分數 70 分以上",
      "考核後生成完整分析報告",
      "",
      "【考核重點提醒】",
      "　• 開場要自然，不要像在念稿",
      "　• STEP2-STEP3 深入了解客戶的程式基礎、學習動機、轉職目標",
      "　• 用三步引導法：確認興趣→展示成果→安排體驗",
      "　• 遇到異議用 OOschool 的處理方式：帶數據、舉案例、算 ROI",
      "　• 收尾給選擇不問要不要",
    ],
    keyPoints: [
      "把考核當作真實的一通開發 Call，不要因為考試就緊張過頭",
      "記得引導不是說服，要讓客戶自己說出對 AI/Python 的學習需求",
      "STEP2-STEP3 多聊天，不要急著進入銷售環節——了解他的程式基礎和轉職動機",
      "考核可以重複進行，每次都會有不同受眾背景（大學生/轉職者/創業家）",
    ],
    trainerTips: [
      "聲音放輕鬆，越緊張越卡，必要時站起來講",
      "架構要完整走完，不要跳步驟",
      "收尾時給選擇，不要問「要不要」",
      "OOschool 的客戶對 AI 有好奇心——用這個好奇心引導他，不要硬銷",
    ],
    practiceTask: "完成實戰考核，針對考核報告寫出 2 好 + 3 優化，制定下一步個人訓練計畫",
    hasSparring: true,
    sparringType: "exam",
    tasks: [
      { id: "o9t1", title: "考前準備", type: "info", description: "放輕鬆，把考核當作真實的一通開發 Call。複習三步引導法和常見反對問題處理" },
      { id: "o9t2", title: "完成實戰考核", type: "practice", description: "模擬真實客戶（大學生/轉職者/創業家），完整走完開發 Call 7 步驟", tip: "70 分及格，架構要完整走完不要跳步驟" },
      { id: "o9t3", title: "考核報告：2 好 + 3 優化", type: "note", description: "針對考核報告寫出反思" },
      { id: "o9t4", title: "制定個人訓練計畫", type: "note", description: "根據考核結果，制定下一步自我提升方向。重點加強哪個受眾？哪個環節？" },
      { id: "o9t5", title: "完成最終測驗", type: "quiz", description: "完成 9 天 OOschool 訓練！", tip: "及格線 60 分" },
    ],
    quiz: [
      {
        question: "實戰考核的及格標準是？",
      ...
      {
        question: "OOschool 三步引導法是？",
        options: ["報價→折扣→成交", "確認興趣→展示成果→安排體驗", "問問題→回答→掛電話", "介紹公司→介紹課程→報價"],
        answer: 1,
      },
      {
        question: "OOschool 的教學核心路徑是？",
        options: ["隨便學都可以", "Python基礎→AI應用→數據分析→機械學習→專案實作", "只學 Python", "只學 AI"],
        answer: 1,
      },
    ],
  },
