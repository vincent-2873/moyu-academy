...
export const videoCategories: VideoCategory[] = [
  ...
  },
  {
    id: "xlab-demo",
    title: "XLAB 教學示範",
    description: "XLAB 內部教學 DEMO 流程與實戰錄影",
    icon: "🧪",
    brands: ["ooschool"],
  },
  {
    id: "ooschool-learning",
    title: "無限學習影片",
    description: "OOschool 業務訓練與領域知識學習影片",
    icon: "📖",
    brands: ["ooschool"],
  },
];
...
export const trainingVideos: TrainingVideo[] = [
  ...
  {
    id: "v-xlab-slides",
    title: "職能共學平台 (XLAB) 2026 簡報",
    description: "XLAB 內部教學簡報資料",
    driveFileId: "1uk679wX7KLqkroQCrxisrW2OxziGT-9ohZxNT5c1_xA",
    type: "slides",
    size: "3 MB",
    brands: ["ooschool"],
    relatedDays: [8],
  ...
  {
    id: "v-xlab-flow",
    title: "XLAB DEMO 流程示範",
    description: "XLAB 標準 DEMO 流程完整示範影片",
    driveFileId: "1osw3Jkh9D6TbHxxg9H1DeyRtqwt8bQwi",
    type: "video",
    size: "300 MB",
    brands: ["ooschool"],
    relatedDays: [8],
  ...
  {
    id: "v-xlab-zhangxinwei",
    title: "張信維 DEMO",
    description: "張信維的 XLAB 實戰 DEMO 錄影",
    driveFileId: "1vP84af-XHazasiMZFoAduPyigMV_gWBh",
    type: "video",
    size: "400 MB",
    brands: ["ooschool"],
    relatedDays: [8],
  ...
  },
  {
    id: "v-xlab-linyoujie",
    title: "林侑頡 DEMO",
    description: "林侑頡的 XLAB 實戰 DEMO 錄影",
    driveFileId: "1kAmhI72RI0jLJFXfJTGuG5Yu82EVuX6Q",
    type: "video",
    size: "400 MB",
    brands: ["ooschool"],
    relatedDays: [8],
  ...
  },
  {
    id: "v-xlab-dulixin",
    title: "杜立心 DEMO",
    description: "杜立心的 XLAB 實戰 DEMO 錄影",
    driveFileId: "1tSWjIhNRWuRMcjSC5lDnv_RLnd0KWpGA",
    type: "video",
    size: "400 MB",
    brands: ["ooschool"],
    relatedDays: [8],
  ...
  // === 無限學習影片 ===
  {
    id: "v-ooschool-learning-1",
    title: "OOschool 業務訓練影片",
    description: "無限學院業務開發與銷售訓練完整教學",
    driveFileId: "1YGUBL7LTOD1QDuurH8cvAdxA0wRPPwx1",
    type: "video",
    size: "500 MB",
    brands: ["ooschool"],
    relatedDays: [1, 2, 3],
    category: "ooschool-learning",
  },
];
