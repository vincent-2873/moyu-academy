...
export const videoCategories: VideoCategory[] = [
  ...
  },
  {
    id: "xlab-demo",
    title: "XLAB DEMO 範例",
    description: "XLAB 品牌 DEMO 流程與實戰錄影",
    icon: "🎬",
    brands: [],
  },
  {
...
export const trainingVideos: TrainingVideo[] = [
  ...
  {
    id: "v-xlab-slides",
    title: "職能共學平台 (XLAB) 2026",
    description: "XLAB 品牌簡報資料",
  ...
  },
  {
    ...
    description: "標準 XLAB DEMO 流程完整示範",
