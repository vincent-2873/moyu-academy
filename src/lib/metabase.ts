...
export function normaliseRow(
  ...
  // Brand alias — Metabase 源頭用 "sixdigital"，系統內統一叫 "ooschool" (無限學院)
  // 2026-04-30 修：移除 xlab→aischool alias。Vincent 規格：xlab = X LAB AI 實驗室(實體)，
  // aischool = 未來學院，**兩個是不同 brand**，不能 merge。
