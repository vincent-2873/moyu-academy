...
type AdminTab = "pillars" | "sales" | "legal" | "commands" | "org" | "people" | "people-edit" | "training" | "messaging" | "line-templates" | "setup" | "rules" | "kpi" | "health" | "cron" | "knowledge" | "system-hub" | "strategy" | "group" | "predict" | "command-center" | "stamp-rules" | "assets" | "employees-sync" | "run-log" | "rag-upload" | "rag-review" | "metabase-audit";
...
export default function AdminPage() {
  ...
  const tabGroups: { label: string; children: AdminTab[] }[] = [
    ...
    { label: "三大戰線", children: ["sales", "legal", "rules", "kpi"] },
      ...
      <div style={{ background: "var(--bg-paper, #f7f1e3)", border: "1px solid var(--border-soft, rgba(26,26,26,0.10))", borderRadius: 6, padding: "48px 40px", width: "100%", maxWidth: 420, boxShadow: "0 4px 20px rgba(26,26,26,0.06)" }}>
        ...
        <a
          ...
          style={{
            ...
            background: "#fff", color: "#3c4043", fontSize: 15, fontWeight: 600,
        ...
        <a
          ...
          style={{
            display: "flex", alignItems: "center", justifyContent: "center", gap: 8,
            width: "100%", padding: 13, borderRadius: 10, marginTop: 10,
            background: "#5865F2", color: "#fff", fontSize: 15, fontWeight: 600,
...
// RecruitCompanyCard 已於 Phase A 補刀砍除(人資招募 104 全砍)
...
function CompanyDrilldown({ brandId }: { brandId: CompanyScope }) {
  ...
  return (
    <div>
      ...
      {/* Metrics grid — Phase A 補刀後 only sales(人資招募 104 全砍) */}
...
// RecruitDrilldownDetails 已於 Phase A 補刀砍除(人資招募 104 全砍)
...
// 已於 Phase A 補刀全砍(對齊 system-tree v2「人資招募 104 全砍」)
// 原 line 3445-3728 含 AutomationData / AutomationTab / ProgressCard 全 dead
...
// ─── Recruits Tab + Documents + Form ───────────────────────────────────
// 已於 Phase A 補刀全砍(對齊 system-tree v2「人資招募 104 全砍」)
// 原 line 3983-4787 含 interface Recruit / RECRUIT_STAGES / FUNNEL_STAGES / FINAL_STAGES /
// RecruitsTab / DrawerSection / Field / formatRelativeTime / interface RecruitDocument /
// DOC_TYPE_LABELS / RecruitDocumentsSection / RecruitDocumentForm / RecruitForm 全 dead
