...
export async function GET(req: NextRequest) {
  ...
  // 2026-05-02 fix:is_monthly_rollup column 沒建過(grep 0 migration 寫過),filter 觸發 PostgREST 錯誤 → query 回 [] → ceo 全 0
  // Metabase Q1381 只同步 daily row,沒 monthly rollup,filter 拿掉
